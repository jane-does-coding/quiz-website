...
const CardsGrid = ({ cards }: any) => {
	return (
		<div className="flex flex-col gap-1 items-center justify-between mx-auto p-2">
			<div className="flex gap-1 w-full">
				<Card className="bg-neutral-100 shadow-sm rounded-[0.5rem] border-none w-2/4 flex items-center justify-center">
				...
				<Card className="bg-neutral-100 shadow-sm rounded-[0.5rem] border-none w-1/4">
					<CardHeader>
